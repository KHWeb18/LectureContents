    ...
    <div>
        ...
        <v-container fluid>
            ...
            <v-layout row wrap>
                ...
                <v-flex xs12 sm6 class="primary white--text">
                    <div>{{ message }}</div>
                </v-flex>
                <v-flex xs4 sm2 class="green white--text">
                    <div>{{ message }}</div>
                </v-flex>
                <v-flex xs4 sm2 class="green white--text">
                    <div>{{ message }}</div>
            ...
            <v-layout row wrap>
                <v-flex xs4 sm3 class="teal white--text">
                    <div>{{ message }}</div>
                </v-flex>
                 <v-flex xs4 sm3 class="teal white--text">
                    <div>{{ message }}</div>
        ...
        <v-layout row justify-center>
            ...
            <v-dialog v-model="payDialog" persistent max-width="400">
                ...
                <v-card>
                    ...
                    <v-card-text>
                        5 성급 호텔이 30% 할인!! {{ service.name }} 결제하겠습니까??
                    </v-card-text>
                        <v-card-actions>
                            <v-spacer></v-spacer>
        ...
        <v-toolbar>
           <!-- <v-toolbar-items class="hidden-sm-and-down"> -->
                ...
                <v-btn text>집에 갈래</v-btn>
                <v-btn text>Come On!</v-btn>
            </v-toolbar-items>
        </v-toolbar>
...
export default {
    ...
    data () {
        return {
            ...
            contents:[
                { boardNo: 1, title: '무야호' , writer: '야야호~', content: 'zzzz'},
                { boardNo: 2, title: '야야호호호호' , writer: '으으으~', content: '키키키'},
                { boardNo: 3, title: '무무야야호호' , writer: '무야호~~~', content: '오잉'},
                { boardNo: 4, title: '무야44호' , writer: '야야호~', content: 'zzzz'},
                { boardNo: 5, title: '야야호5555호호호' , writer: '으으으~', content: '키키키'},
                { boardNo: 6, title: '무무야666야호호' , writer: '무야호~~~', content: '오잉'},
                { boardNo: 7, title: '무야777호' , writer: '야야호~', content: 'zzzz'},
                { boardNo: 8, title: '야야888호호호호' , writer: '으으으~', content: '키키키'},
                { boardNo: 9, title: '무무999야야호호' , writer: '무야호~~~', content: '오잉'},
                { boardNo: 10, title: '무000야호' , writer: '야야호~', content: 'zzzz'},
                { boardNo: 11, title: '야야---호호호호' , writer: '으으으~', content: '키키키'},
                { boardNo: 12, title: '무무=====야야호호' , writer: '무야호~~~', content: '오잉'},
            ],
            message: '환장~',
            nav_drawer: false,
            group: false,
            ...
            links: [
                ...
                {
                icon: 'ac_unit', text: '눈', name: 'ac_unit', route: '/product'
            },
                {
                icon: 'attach_money', text: '달러', name: 'attach_money', route: '/materialize'
            }
            ],
            dropItems: [
                { title: '하이'},
