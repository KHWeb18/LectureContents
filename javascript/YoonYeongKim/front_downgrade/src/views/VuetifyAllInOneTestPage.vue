<template>
    <div>
        ...
        <v-toolbar>
            ...
            <!-- <v-toolbar-item v-if="$vuetify.breakpoint.xsOnly"> -->
        ...
        <v-toolbar>
            ...
            <v-toolbar-items class="hidden-sm-and-down">
                ...
                <v-btn text>나는 집입니다</v-btn>
            </v-toolbar-items>
        </v-toolbar>

        <!-- 클릭 시 이동하려면 v-on 사용-->
        <!--
        <v-navigation-drawer app parmanent>
            <v-list nav dense>
    ...
    data () {
        return {
            ...
            links: [
                ...
                {
                    icon: 'today', text: 'Today', name: 'Today', route: '/monster'
                }, 
                {
                    icon: 'history', text: 'History', name: 'History', route: '/materialize'
                }   
            ],
            dropItems: [
                { title: 'Click Me' },
