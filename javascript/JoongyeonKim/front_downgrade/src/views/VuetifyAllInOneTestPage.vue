    ...
    <div>
        ...
        <v-layout row justify-center> 
            <!-- 사용자에게 알림을 제공하거나 중요정보를 포함해 의사 결정을 하도록 유도하는데 활용
                 ...
                 여러 대화상자(dialog)를 사용한다면 이 부분을 여러개로 분리하거나 배열로 관리해야한다-->
        ...
        <v-container>
            <!--:headers, :items는 v-data-table에 props로 들어있다 (값을 넣어주면 vuetify가 해결해준다) -->
    ...
    data () {
        return {
            ...
            contents: [
                ...
                { boardNo: 2, title: '호야', writer: '어어어어', content: '어어어어' },
                { boardNo: 3, title: '타토', writer: '나나나나', content: '나나나나' },
                { boardNo: 4, title: '야호', writer: '으마으마', content: '으아아앜' },
                { boardNo: 5, title: '호야', writer: '어어어어', content: '어어어어' },
                { boardNo: 6, title: '타토', writer: '나나나나', content: '나나나나' },
                { boardNo: 7, title: '야호', writer: '으마으마', content: '으아아앜' },
                { boardNo: 8, title: '호야', writer: '어어어어', content: '어어어어' },
                { boardNo: 9, title: '타토', writer: '나나나나', content: '나나나나' },
                { boardNo: 10, title: '야호', writer: '으마으마', content: '으아아앜' },
                { boardNo: 11, title: '호야', writer: '어어어어', content: '어어어어' },
                { boardNo: 12, title: '타토', writer: '나나나나', content: '나나나나' },
                { boardNo: 13, title: '야호', writer: '으마으마', content: '으아아앜' },
                { boardNo: 14, title: '호야', writer: '어어어어', content: '어어어어' },
                { boardNo: 15, title: '타토', writer: '나나나나', content: '나나나나' }
            ],
            message: '환장',
            nav_drawer: false,
            group: false,
