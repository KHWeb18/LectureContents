...
//
////        document = connectUrl("https://news.naver.com/main/" + category);
//
////         축제
////        document = connectUrl("https://search.naver.com/search.naver?where=nexearch&sm=top_hty&fbm=1&ie=utf8&query=" + category);
////
////        daumNewsRepository.deleteAll();
////
////        daumNewsCrawling(document.select(
////                "div.card_area>div.card_item>div.data_area" +
////                        ">div.data_box>div.title>div.area_text_box" +
////                        ">strong.this_text>a"), category);
//
//
//        // 날씨 뉴스
////        document = connectUrl("https://weather.naver.com/news/" + category);
////        daumNewsRepository.deleteAll();
////        daumNewsCrawling(document.select(
////                "div.area_inner>a>strong"), category);
//
//// 서귀포 관광
////        document = connectUrl("https://search.naver.com/search.naver?where=nexearch&sm=top_hty&fbm=1&ie=utf8&query=" + category);
////        daumNewsRepository.deleteAll();
